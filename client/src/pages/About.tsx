      ...
      <div className="bg-gradient-to-br from-[#1a2b4c] to-[#2d4a7a] text-white py-16 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <div className="flex justify-center mb-6">
            <img
              src="/manus-storage/kenny_logo_a9bc7105.png"
      ...
      <div className="max-w-3xl mx-auto px-6 py-12 space-y-8">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-5">
              ...
              <div className="flex-1 text-center sm:text-left">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed mb-3">
                  If you enjoy the models, the library, or just want to help keep the printers running —
                  buying a coffee goes a long way. Every bit is appreciated!
                </p>
                <a
        ...
        <Card>
          <CardContent className="pt-6">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
              Kenny Print It? is an online 3D model library that organizes and showcases Kenny's
              printable designs. Browse by category, search by tag, preview models in the built-in
              STL viewer, and download ZIP packages — all in one place.
            </p>
            <p className="text-sm text-muted-foreground leading-relaxed">
              Models are synced automatically from Google Drive and tagged with AI so you can find
        ...
        <div className="text-center text-xs text-muted-foreground pb-4">
          <p>Kenny Print It? — 3D Printing &amp; Designs</p>
          <p className="mt-1">Hobby, Cosplay, Toys, Gadgets &amp; Mods</p>
        </div>
      </div>
    </div>
  );
