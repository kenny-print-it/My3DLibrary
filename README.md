...
No installation required. Runs on Windows 10/11 and macOS (Intel & Apple Silicon) — no installation required.
...
2. **Windows:** Double-click `My3DLibrary.exe` — **macOS:** Double-click `My3DLibrary.app`
